...
export default class Modal extends Component {
	...
	render(props, state) {
		return <div class={`modal modal-preact ${!props.noClose && "noClose"} ${props.reloadSectionsOnClose ? "reloadSectionsOnClose" : ""} ${props.class ? props.class : ""}`} style="display: block; padding-left: 0px">
