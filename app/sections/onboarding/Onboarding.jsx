			...
			<div class="row features">
				<div class="col-md-4 feature">
					...
					<p>Customize DaltonTab to your liking by changing settings. To access settings,
                        use the <i class="fa fa-fw fa-cog"></i> button in the upper right-hand corner of
				...
				<div class="col-md-4 feature">
					...
					<i class="fa fa-fw fa-cog"></i> button in the upper right-hand corner of the screen.
                        From there, you can use the <i class="fa fa-fw fa-th-large"></i> Layout settings to
				...
				<div class="col-md-4 feature">
					...
					<p>To remove this "Getting Started" section, open settings by clicking the
						<i class="fa fa-fw fa-cog"></i> button in the upper right-hand corner of the screen.
                        From there, click the <i class="fa fa-fw fa-trash"></i> button next to "Getting Started."
